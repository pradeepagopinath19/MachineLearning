...
def extract_full_dataset():
    url = "http://www.ccs.neu.edu/home/vip/teach/MLcourse/3_generative_models/HW3/3gaussian.txt"
...
def main():
    ...
    count_n1 = 0
    count_n2 = 0
    for first, second, third in z_im:
    ...
    print("n2 = ", count_n2, "points")
    print("n3=", len(z_im)- (count_n1+count_n2), "points")
